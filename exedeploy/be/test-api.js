...
async function runTests() {
  ...
  try {
    ...
    // Expected total price: 250000 * 2 + 350000 * 1 = 850000
    if (cartAdd2Json.cart.total_price !== 850000) {
      throw new Error(`Expected cart total price 850000 but got ${cartAdd2Json.cart.total_price}`);
    }
